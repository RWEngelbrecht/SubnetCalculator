/*
Copyright © 2021 Rigardt Engelbrecht <rigardt@brechtburg.co.za>
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "c", "config file (default is $HOME/.SubnetCalculator.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".SubnetCalculator" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".SubnetCalculator")
	}
